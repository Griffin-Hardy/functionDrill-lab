...
//CODE HERE
let nameGreeting = nameCheck("griffin")
...
bestMovie('hereditary')
console.log(bestMovie('hereditary'))
...
emailCheck('me@gmail.com')
console.log(emailCheck('me@gmail.com'))
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
function frog(budget){
  return budget / 3
}
let totalFrogs = frog(30)
...
//CODE HERE
function frog2(budget){
if (budget % 3 === 0){
  return budget / 3
} else if ((budget - 1) % 3 === 0){
  return (budget - 1) / 3
} else {
  return (budget - 2) / 3
}
...
let arrayIsAscending = arrCheck(sampleArray)
console.log(arrCheck(sampleArray))
////////////////// PROBLEM 22 ////////////////////
